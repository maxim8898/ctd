...
const TodoForm: React.FC<TodoFormProps> = ({item, items, timestamp, setTodo, onClose}: TodoFormProps) => {
  ...
  return (
    <>
      ...
      <button
        className="flex h-10 w-40 my-4 mx-auto items-center justify-center overflow-hidden bg-purple-600 rounded-lg font-medium text-white"
        onClick={editTodo}
